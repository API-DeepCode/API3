          ...
          <footer>
               <div className="footer-info">
                    <section className="footer-first-section">
                         <Image
                              src="https://entrenova.com.br/wp-content/uploads/2025/02/logo_branco.svg"
                              width={250}
                              height={80}
                              alt="Logo Entrenova branca"
                         />
                    ...
                    <section className="footer-address-section">
                         ...
                         <h3>Estrada Doutor Altino Bondesan, 500 Distrito de Eugênio de Melo – São José dos Campos – SP 12247-016</h3>
                    </section>
               </div>

               <div className="footer-copyright">
                    <h3>Entrenova © Todos os direitos reservados. 2025 – Maarantes Web Design</h3>
